...
static cvarTable_t cvarTable[] =
{
	...
	{ &ui_SFXSabers,		    "cg_SFXSabers",     	"3",NULL, CVAR_ARCHIVE },
...
static void UI_BuildPlayerModel_List( qboolean inGameLoad )
{
	...
	for (i=0; i<numdirs; i++,dirptr+=dirlen+1)
	{
		...
		{
			Com_sprintf(fpath, sizeof(fpath), "models/players/%s/PlayerChoicemod.txt", dirptr);//mod version 
		}
...
void ReadSaveDirectory (void)
{
	...
	if (com_outcast->integer == 0)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-JKA", ".sav", s_savegame.listBuf, LISTBUFSIZE);//academy version
	}
	else if (com_outcast->integer == 1)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-JKO", ".sav", s_savegame.listBuf, LISTBUFSIZE);//outcast version 
	}
	else if (com_outcast->integer == 2)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-DF", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 3)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-YAV", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 4)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-KOTOR", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 5)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-KOTOR", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	...
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-SECRET", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 7)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-NOC", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 8)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-PIB", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 9)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-RED", ".sav", s_savegame.listBuf, LISTBUFSIZE);//mod version 
	}
	else if (com_outcast->integer == 10)
	{
	...
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-JKA", ".sav", s_savegame.listBuf, LISTBUFSIZE);
	}
