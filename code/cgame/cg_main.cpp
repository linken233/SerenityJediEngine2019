...
static cvarTable_t cvarTable[] = {
	...
	{ &cg_thirdPersonRange, "cg_thirdPersonRange", "85", CVAR_ARCHIVE },
	...
	{ &cg_truefov,	        "cg_truefov",	        "85",CVAR_ARCHIVE },
...
//	cgs.media.talkSound = 	cgi_S_RegisterSound( "sound/interface/communicator.wav" );
	...
	cgs.media.overheatgun           = cgi_S_RegisterSound("sound/weapons/reload.mp3");
	...
	cgs.media.impressiveSound = cgi_S_RegisterSound("sound/chars/protocol/misc/40MOM025");
			...
			if(g_entities[i].client)
			{
				...
				//We presume this
				{
					...
					{//Client weapons already precached
						...
						{
							cgs.media.customSaberGlowShader = cgi_R_RegisterShader(g_entities[i].client->ps.saber[0].glowshader);
						}
						if (g_entities[i].client->ps.saber[0].bladeshader[0])
						{
							cgs.media.customSaberCoreShader = cgi_R_RegisterShader(g_entities[i].client->ps.saber[0].bladeshader);
						}
