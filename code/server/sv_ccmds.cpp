...
static void SV_CompleteSaveName( char *args, int argNum )
{
	if ( argNum == 2 )
	{
		...
		{
			Field_CompleteFilename("Account/Saved-Missions-JKA/", "sav", qtrue, qtrue);
		}
		else if (com_outcast->integer == 1)
		{
			Field_CompleteFilename("Account/Saved-Missions-JKO/", "sav", qtrue, qtrue);
		}
		else if (com_outcast->integer == 2)
		{
			Field_CompleteFilename("Account/Saved-Missions-DF/", "sav", qtrue, qtrue);
		}
