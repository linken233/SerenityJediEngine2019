...
#if JK2_MODE
#define PRODUCT_NAME			"SerenityJediEngineJO2018-SP"

#define CLIENT_WINDOW_TITLE "SerenityJediEngine2019 (SP)"
#define CLIENT_CONSOLE_TITLE "SerenityJediEngine2019 Console (SP)"
#define HOMEPATH_NAME_UNIX "SerenityJediEngine2019"
#define HOMEPATH_NAME_WIN "SerenityJediEngineJO2018"
#define HOMEPATH_NAME_MACOSX HOMEPATH_NAME_WIN
#else
#define PRODUCT_NAME			"SerenityJediEngine2019-SP"

#define CLIENT_WINDOW_TITLE "SerenityJediEngine2019 (SP)"
#define CLIENT_CONSOLE_TITLE "SerenityJediEngine2019 Console (SP)"
#define HOMEPATH_NAME_UNIX "SerenityJediEngine2019"
#define HOMEPATH_NAME_WIN "SerenityJediEngine2019"
#define HOMEPATH_NAME_MACOSX HOMEPATH_NAME_WIN
#endif

#define	BASEGAME "base"
#define OPENJKGAME "SerenityJediEngine2019"
...
public:
	...
	qboolean	dualSabers;
	qboolean	SaberStaff( void ) { return (qboolean)( saber[0].type == SABER_STAFF || saber[0].type == SABER_STAFF_UNSTABLE || saber[0].type == SABER_STAFF_SFX || saber[0].type == SABER_STAFF_THIN || saber[0].type == SABER_STAFF_MAUL || saber[0].type == SABER_ELECTROSTAFF || (dualSabers && saber[1].type == SABER_STAFF) ); };
		...
		ojk::SavedGameHelper& saved_game) const
	{
		...
		saved_game.write<int32_t>(saberKnockedTime);
		...
		ojk::SavedGameHelper& saved_game)
	{
		...
		saved_game.read<int32_t>(saberKnockedTime);
