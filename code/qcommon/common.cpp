...
skip loading of SerenityJediEngine2019-SP.cfg
===================
*/
...
void Com_Init( char *commandLine ) {
	...
	try {
		...
		com_outcast = Cvar_Get("com_outcast", "0", CVAR_ARCHIVE);
		...
		{
			Com_Printf("Running MovieDuels Mode\n");
		}
		else
		{
...
void Com_WriteConfigToFile( const char *filename ) {
	...
	FS_Printf (f, "// generated by SerenityJediEngine2019 SP, do not modify\n");
	Key_WriteBindings (f);
