	...
	const std::string& base_file_name)
{
	...
	{
		return "Account/Saved-Missions-JKA/" + normalized_file_name + ".sav";
	}
	else if (com_outcast->integer == 1)
	{
		return "Account/Saved-Missions-JKO/" + normalized_file_name + ".sav";
	}
	else if (com_outcast->integer == 2)
	{
		return "Account/Saved-Missions-DF/" + normalized_file_name + ".sav";
	}
