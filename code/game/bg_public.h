...
#define FATIGUE_AUTOSABERDEFENSE 10
#define FATIGUE_SPECIALMOVE		2
#define FATIGUE_AUTOBOLTBLOCK	2
#define FATIGUE_ATTACKFAKE		2
#define FATIGUE_DODGE   		30
#define FATIGUE_DODGEING   		25
#define FATIGUE_DODGEINGBOT   	70
#define FATIGUE_AUTOSABERBOLTBLOCK	3
...
#define DODGE_TUSKENBLOCK	    5
#define DODGE_REPEATERBLOCK		1  //the cost of blocking repeater shots is lower since the repeater shoots much faster.
...
#define __SABER_COMBATANIMATION_SMOOTH__
...
#define PMF_PRONE		    (1<<20)//SERENITY FOR PRONE VIEWS AND MOVES?
#define PMF_LADDER		    (1<<21)//524288	
#define PMF_LADDER_JUMP		(1<<22)//0x00002000		// Jumped off a ladder
#define PMF_GRAPPLE_PULL	(1<<23)
...
typedef enum {
	...
	PERS_PLAYEREVENTS,				// incremented for each reward sound
...
#define PW_REMOVE_AT_DEATH ((1<<PW_QUAD)|(1<<PW_BATTLESUIT)|(1<<PW_HASTE)|(1<<PW_CLOAKED)|(1<<PW_UNCLOAKING)|(1<<PW_GALAK_SHIELD)|(1<<PW_DISINT_2)|(1<<PW_INVINCIBLE)|(1<<PW_SEEKER)|(1<<PW_JETPACK))
