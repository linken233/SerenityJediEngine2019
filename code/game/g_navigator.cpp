...
void			NAV::SpawnedPoint(gentity_t* ent, NAV::EPointType type)
{
	...
	if (com_outcast->integer == 0)//academy version
	{
	...
	else if (com_outcast->integer == 1)//outcast version 
	{
		//outcast version
	}
	...
	else if (com_outcast->integer == 7)//outcast version 
	{
		//outcast version
	}
	else if (com_outcast->integer == 8)//outcast version 
	{
		//outcast version
	}
	else if (com_outcast->integer == 9)//outcast version 
	{
		if (CHECK_START_SOLID)
		{
			// Try It
	...
	else if (com_outcast->integer == 10)//outcast version 
	{
	if (CHECK_START_SOLID)
	{
		// Try It
