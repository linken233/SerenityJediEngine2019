...
void CG_GrappleTrail(centity_t *ent, const weaponInfo_t *wi)
{
	...
	BG_EvaluateTrajectory(&es->pos, cg.time, to);
	...
	trap->FX_AddLine(from, to, 0.1f, 0.5f, 0.0f, 0.5f, 0.0f, 0.0f, BLUER, BLUER, 0.0f, 15, trap->R_RegisterShader("gfx/misc/bolt1"), FX_SIZE_LINEAR);
}
