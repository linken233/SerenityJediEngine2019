...
static void CG_RegisterSounds(void) {
	...
	trap->S_RegisterSound("sound/weapons/force/lightning2");
	trap->S_RegisterSound("sound/weapons/force/lightning3");
	...
	cgs.media.overheatgun = trap->S_RegisterSound("sound/weapons/reload.mp3");
