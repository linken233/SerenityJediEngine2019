...
void Com_InitZoneMemory( void )
{
	...
	Com_Printf("More damage at the end of the swing should maintain the fast-paced feel of JKA. Well-timed and well-aimed\n");
	Com_Printf("slashes are more effective than on basejka.\n");
	Com_Printf("This could potentially improve the way we play saber-only JKA quite a lot. Less spam-friendly, and more accurate\n");
