...
qboolean sje_is_ally(gentity_t *ent, gentity_t *other)
{
...
int sje_number_of_allies(gentity_t *ent)
{
	int i = 0;
...
void ShieldTouch(gentity_t *self, gentity_t *other, trace_t *trace)
{
	...
	{ // let teammates through
		...
		if (self->parent && ( self->parent->client) && (other->client))
		{
			...
			else if (self->parent && self->parent->client && sje_is_ally(self->parent, other) == qtrue)
...
void Flamethrower_Fire( gentity_t *self )
{
	...
	int damage = FLAMETHROWER_DAMAGE;
