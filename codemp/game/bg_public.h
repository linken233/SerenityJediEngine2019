...
#define	GAME_VERSION		"SerenityJediEngine2019"
...
#define CURRENT_SJE_CLIENTVERSION		"SerenityJediEngine2019 v1.0"
...
#define PW_REMOVE_AT_DEATH ((1<<PW_QUAD)|(1<<PW_BATTLESUIT)|(1<<PW_CLOAKED)|(1<<PW_GALAK_SHIELD)|(1<<PW_INVINCIBLE))
...
#define BOT_KNOCKDOWN_HOLD_EXTRA_TIME	    600
//KNOCKOVERHOLD
