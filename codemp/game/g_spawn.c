	...
	while (i < level.sje_spawn_strings_values_count[ent->s.number])
	{
		...
		{ // found the key
			...
			{ // remove the key
				...
				while (i < level.sje_spawn_strings_values_count[ent->s.number])
				{
					level.sje_spawn_strings[ent->s.number][i - 2] = G_NewString(level.sje_spawn_strings[ent->s.number][i]);
					level.sje_spawn_strings[ent->s.number][i - 1] = G_NewString(level.sje_spawn_strings[ent->s.number][i + 1]);
